...
class line:
    ...
    변수로는 외부에서 접근 불가능한 __length가 있으며,초기 값은 0입니다. 또한 생성자를 통해 초기 __length값을 지정할 수 있습니다.
    해당 변수를 수정하고 접근하기 위해
    ...
    def get_length(self):
        ...
        Returns:
            int of float: 저장하고 있는 선의 길이입니다.
        """
        return self.__length
   
def area_square(length):
        """ 길이를 입력받아 정사각형의 넓아를 구하는 함수입니다.
        Args:
            length (int or float): 한 변의 길이 입니다.
        Returns:
...
def area_regular_triangle(length):
        ...
        Args:
            length (int of float): 한 변의 길이입니다.
        Returns:
